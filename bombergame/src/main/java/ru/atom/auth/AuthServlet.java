...
import static ru.atom.network.TokenStorage.getByToken;
import static ru.atom.network.TokenStorage.getLoginByName;
import static ru.atom.network.TokenStorage.logoutToken;
import static ru.atom.network.TokenStorage.saveLogin;
import static ru.atom.network.UserStorage.getByName;
import static ru.atom.network.UserStorage.insert;
import static ru.atom.network.PasswordHasher.checkPassword;
import static ru.atom.network.PasswordHasher.hashPassword;
